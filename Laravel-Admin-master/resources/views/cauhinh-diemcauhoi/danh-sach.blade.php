                    ...
                    <div class="col-12" >
                        <div class="card">
                            <div class="card-body">
                                ...
                                <a style="margin-bottom:10px" href="{{ route('cau-hinh-diem-cau-hoi.them-moi') }}" class="btn btn-info btn-rounded waves-effect waves-light">
                                ...
                                <table id="cauHinh-datatable" class="table dt-responsive nowrap">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $cauHinh->diem}} </td>
                                            <td>
                                            <a href="{{ route('cau-hinh-diem-cau-hoi.cap-nhat',['id'=> $cauHinh->id]) }}" class="btn btn-purple waves-effect waves-light"><i class=" mdi mdi-pencil-outline"></i></a>
                                            ...
                                            <script type="text/javascript">
                                                function del(){
                                                    ...
                                                    if (result.value) {
                                                        window.location.href = "{{ route('cau-hinh-diem-cau-hoi.xoa',['id'=> $cauHinh->id]) }}";
                                                    }
                                                    })
                                                };
                                            </script>
